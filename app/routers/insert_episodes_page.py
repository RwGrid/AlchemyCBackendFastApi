...
async def read_item(
    ...
    try:
        ...
        episode_json={'formFake': '', 'formDay': 'الثلاثاء', 'formProgramName': 'asdfasdf', 'formEpisodeType': 'zxvxzcv', 'formSummary': 'summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary summary ', 'formMashhadSa5en': '', 'formMashhadSeyasi': '', 'formMashhadSaqafi': '', 'formMashhadOnline': '', 'formSiyasiyaMalaf1': '', 'formSiyasiyaMalaf2': '', 'formSiyasiyaMalaf3': '', 'formSiyasiyaMalaf4': '', 'formYoutubeLink': '', 'formHosts': [{'value': 'asdfasdf', 'label': 'asdfasdf'}], 'formSubSubjects': [], 'formEditors': [{'value': 'kukuiui', 'label': 'kukuiui'}, {'value': 'ewqrwer', 'label': 'ewqrwer'}], 'formGraphic': [{'value': 'vxcxcvxcv', 'label': 'vxcxcvxcv'}], 'formGuests': [{'GuestName': 'ewwerew', 'GuestId': 3, 'GuestDesc': ['ertretre'], 'GuestErrors': {'guestDescRequired': ''}}, {'GuestName': 'xxxx', 'GuestId': 2, 'GuestDesc': ['xxxxx'], 'GuestErrors': {'guestDescRequired': ''}}], 'formMainSubject': 'title 1 ', 'formEpiTime': '2023-07-05T13:09:17.439Z', 'formSectionDuration': '1:50', 'formSections': [{'SectionStart': '0:00:00', 'SectionEnd': '0:50:00', 'SectionTitle': 'makta31'}, {'SectionStart': '0:50:00', 'SectionEnd': '1:50:00', 'SectionTitle': 'makta32'}], 'formTags': [{'value': 'tag1', 'id': 1, 'label': 'tag1'}, {'value': 'tag2', 'id': 2, 'label': 'tag2'}]}
